...
descriptive_zmpl(x) <- function(x)
{
  ...
  namescol <- c("Min","Max","Mean","Var","Skew","Kurt","FI")
  valuescol <- cbind(minx,maxx,barx,varx,skwx,kurx,Findex)
  out <- rbind(namescol,valuescol)
  rownames(out) <- c("Measures","Values")
